...
OUTPUT_FILE = "./original/psychology.txt"
OUTPUT_PARSED_FILE = "./latex_parsed/psychology.txt"
...
# Main function to retrieve 600 psychology abstracts 294
def get_psychology_abstracts():
    query = "psychology[MeSH Terms] AND abstract[Title/Abstract]"
    total_abstracts = []
    total_results = 294
    max_per_request = 294
